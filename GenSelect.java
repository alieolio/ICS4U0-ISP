...
public class GenSelect {
    /**
     * Constructor for GenSelect
     * @param bc
     * @param bm Button to select man
     * @param bw Button to select Woman
     * @param bgq Button to select Gender Queer
     * @return the virtual box containing the buttons
     */
